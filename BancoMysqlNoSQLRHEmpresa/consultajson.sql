...
SELECT `JSON` AS JSON_DOC FROM tb_object_funcionario;

SELECT JSON_PRETTY(`JSON`) AS JSON_DOC FROM tb_object_funcionario;
...
SELECT SEXO FROM tb_object_funcionario;
